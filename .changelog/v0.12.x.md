...
### M40: Agent Skill System — Planned
...
- **Agent context compaction**: Output length tracking and compaction metadata for retries that hit context limits, plus output format constraints for verbose task types
